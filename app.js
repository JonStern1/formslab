...
var ballard, firstHill, internationalDistrict, southLakeUnion, georgetown, ravenna;
var pizzaTable;
...
function sum(ballardNumber, firstHillNumber, internationalDistrictNumber, southLakeUnionNumber, georgetownNumber, ravennaNumber) {
  var totalNumber = ballardNumber + firstHillNumber + internationalDistrictNumber + southLakeUnionNumber + georgetownNumber + ravennaNumber * 6;
